...
Image10=rgb2hsv(Image1);
Image20=rgb2hsv(Image2);
%图像分量
Image11=Image10(:,:,1);
Image12=Image10(:,:,2);
Image13=Image10(:,:,3);
...
subplot(2,5,4);imshow(Image13);title('明度(Value)','FontSize',FontSize);
subplot(2,5,5);imshow(Image10);title('HSV','FontSize',FontSize);
...
subplot(2,5,9);imshow(Image23);title('明度(Value)','FontSize',FontSize);
subplot(2,5,10);imshow(Image20);title('HSV','FontSize',FontSize);